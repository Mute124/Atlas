...
VkRenderingAttachmentInfo Atlas::CreateAttachmentInfo(VkImageView view, VkClearValue* clear, VkImageLayout layout)
{
...
VkRenderingInfo Atlas::CreateRenderingInfo(VkExtent2D renderExtent, VkRenderingAttachmentInfo* colorAttachment, VkRenderingAttachmentInfo* depthAttachment)
{
...
VkPipelineLayoutCreateInfo Atlas::CreatePipelineLayoutCreateInfo()
{
...
VkPipelineShaderStageCreateInfo Atlas::CreatePipelineShaderStageCreateInfo(VkShaderStageFlagBits stage, VkShaderModule shaderModule, const char* entry)
{
...
VkRenderingAttachmentInfo Atlas::CreateDepthAttachmentInfo(VkImageView view, VkImageLayout layout)
{
