...
namespace Atlas {
	...
	protected:
		...
		ARenderer(GameWindow* gameWindow, ARenderingBackend* backend, bool canBeMultiThreaded);
	...
	public:
		 ...
		 * @since v
		 */
		GameWindow* mainGameWindow = nullptr;
		 ...
		 * @since v
		 */
		ARenderer(GameWindow* gameWindow, ARenderingBackend* backend);
